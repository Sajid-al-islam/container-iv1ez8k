...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-iv1ez8k.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-iv1ez8k.containers.anotherwebservice.com/
...
```
git clone git@github.com:Sajid-al-islam/container-iv1ez8k.git
cd container-iv1ez8k
```
...
```
docker attach container-iv1ez8k
```
